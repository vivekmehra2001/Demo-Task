...
export default function FeaturedCollection() {
  ...
  return (
    <div className="w-full px-4 sm:px-6 lg:px-12 py-10 ">
      ...
      <p className="text-2xl text-center flex justify-center font-bold mb-10">
        <img src="/images/Featured Collection.svg" className=" w-xs sm:w-sm" />
      </p>
      <p className="text-2xl text-center flex justify-center font-bold mb-8">
        <img src="/images/Signature Handpicked Pieces.svg" className="w-[15rem]" />
      </p>
